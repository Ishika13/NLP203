...
TOKENIZER_PATH = "tokenizer_transformer.pkl"
...
if os.path.exists("src_vocab_transformer.pth") and os.path.exists("tgt_vocab_transformer.pth"):
    print("Loading vocabularies from files...")
    src_vocab = torch.load("src_vocab_transformer.pth")
    tgt_vocab = torch.load("tgt_vocab_transformer.pth")
else:
    print("Building vocabulary...")
    src_vocab = build_vocab_from_iterator(yield_tokens("data/train.txt.src"), specials=["<unk>", "<pad>", "<sos>", "<eos>"], min_freq=3) 
    tgt_vocab = build_vocab_from_iterator(yield_tokens("data/train.txt.tgt"), specials=["<unk>", "<pad>", "<sos>", "<eos>"], min_freq=3)
...
with open("data/test.txt.src", 'r') as f_in, open("predicted_summaries_transformer.txt", 'w') as f_out:
